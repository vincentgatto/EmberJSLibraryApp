define('ember-data/-private', ['exports', 'ember-inflector', 'ember-data/-debug', '@ember/ordered-set', 'ember-data/version'], function (exports, emberInflector, emberData_Debug, EmberOrderedSet, VERSION) { 'use strict';

EmberOrderedSet = 'default' in EmberOrderedSet ? EmberOrderedSet['default'] : EmberOrderedSet;
