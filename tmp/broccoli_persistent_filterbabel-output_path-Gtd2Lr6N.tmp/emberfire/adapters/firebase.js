define('emberfire/adapters/firebase', ['exports', 'ember', 'ember-data', 'emberfire/mixins/waitable', 'emberfire/utils/to-promise', 'ember-inflector'], function (exports, _ember, _emberData, _emberfireMixinsWaitable, _emberfireUtilsToPromise, _emberInflector) {
        ...
        if (relationship.kind === 'hasMany') {
          ...
          if (!relationshipPayload) {
            ...
            if (isEmbedded) {
              ...
              cache[key] = _ember['default'].A(ids);
            }
          }
        }
      });
